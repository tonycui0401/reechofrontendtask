...
import TagService from "../../services/tag.service";
  ...
  class InstitutionSuggestion extends Component{
    constructor(props) {
        super(props);
    ...
    handleDelete(i) {
      ...
      handleAddition(tag) {
        ...
        TagService.createInstitutionTag(tag.text).then(
          response => {
      ...
      if(this.props.tagtype!=="admin"){
        this.props.addInstitution(this.state.tags)
      }
  ...
  export default InstitutionSuggestion;