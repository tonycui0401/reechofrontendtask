...
import TagService from "../../services/tag.service";
  ...
  class EmployerSuggestion extends Component{
    constructor(props) {
        super(props);
    ...
    handleDelete(i) {
      ...
      handleAddition(tag) {
        ...
        TagService.createEmployerTag(tag.text).then(
          response => {
    ...
    //    this.setState(state =>{state.tags.push(tag)})
      ...
      if(this.props.tagtype!=="admin"){
        this.props.addEmployer(this.state.tags)
      } 
  ...
  export default EmployerSuggestion;