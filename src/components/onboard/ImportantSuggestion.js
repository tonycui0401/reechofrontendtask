...
import TagService from "../../services/tag.service";
  ...
  class ImportantSuggestion extends Component{
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
      ...
      TagService.getImportantTags().then(
        response => {
    ...
    handleDelete(i) {
      ...
      handleAddition(tag) {
        ...
        TagService.createImportantTag(tag.text).then(
          response => {
  ...
  export default ImportantSuggestion;