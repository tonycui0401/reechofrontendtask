...
import TagService from "../../services/tag.service";
  ...
  class EducationSuggestion extends Component{
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
      ...
      TagService.getEducationTags().then(
        response => {
    ...
    handleDelete(i) {
      ...
      handleAddition(tag) {
        ...
        TagService.createEducationTag(tag.text).then(
          response => {
    ...
    //    this.setState(state =>{state.tags.push(tag)})
      ...
      if(this.props.tagtype!=="admin"){
        this.props.addEducation(this.state.tags)
      }
