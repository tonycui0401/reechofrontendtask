...
class SearchChatImagesResults extends Component {
...
console.log(this.props.groupchatmsgimages)
console.log("end get the chatgroups list")
   searchgroupchat = this.props.groupchatmsgimages?(this.props.groupchatmsgimages.length>0?(this.props.groupchatmsgimages.map(cm=>
    <a href="#"
    onClick={(e)=>{
      let group = {}
...
const searchchat = this.props.chatmsgimages?(this.props.chatmsgimages.length>0?(this.props.chatmsgimages.map(cm=>
    <a href="#" 
    onClick={(e)=>{
      let user = {}
  ...
  <small className="text-muted">&nbsp;&nbsp;&nbsp;{moment(Number(cm.time)).format('h:mm a')+" "+moment(Number(cm.time)).format('L')}</small>
    ...
    return (     
        ...
        <div className="row">
      {!this.props.selectPrivateInImage?
          searchgroupchat:
          searchchat}
        </div>
    </div>
...
export default SearchChatImagesResults